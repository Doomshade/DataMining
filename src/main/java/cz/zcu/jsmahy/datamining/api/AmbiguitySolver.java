...
/**
 * <p>Solves ambiguities of {@link RDFNode}s where a list of them occurs.</p>
 * <p>An example would be a ruler having multiple descendents.</p>
 *
 * @author Jakub Smrha
 * @since 1.0
 */
public interface AmbiguitySolver<T extends RDFNode> extends Callback<DataNodeList<T>, AtomicReference<DataNode<T>>> {
    /**
